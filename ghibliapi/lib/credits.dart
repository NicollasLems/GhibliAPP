            ...
            Container(
              ...
              height: 50,
                  ...
                  GestureDetector(
                    ...
                    Text("API destinada à filmes do Estúdio Ghibli. Dessa forma, possui o título do filme, diretor, ano de lançamento, imagem, personagens, espécies, veículos, dentre muitos outros dados. Pegamos algumas dessas informações para trazer um breve resumo de cada filme dentro dessa API, além de seu título, diretor e descrição, pegamos também as próprias imagens do filme respectivo.",  textAlign: TextAlign.justify, style: TextStyle(
                    fontSize: 12,
                    color: Colors.white
                  ),),
                    ...
                    Text("Para a construção do conteúdo desse aplicativo, foi-se utilizado do GET para pegar dados da API.", textAlign: TextAlign.justify, style: TextStyle(
                    fontSize: 12,
                    color: Colors.white
                  ),),
